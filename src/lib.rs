...
fn rraft(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_class::<prost_bindings::conf_change_single::Py_ConfChangeSingle_Owner>()?;
    m.add_class::<prost_bindings::conf_change_single::Py_ConfChangeSingle_Ref>()?;
    m.add_class::<prost_bindings::conf_change_transition::Py_ConfChangeTransition>()?;
    m.add_class::<prost_bindings::conf_change_type::Py_ConfChangeType>()?;
    m.add_class::<prost_bindings::conf_change_v2::Py_ConfChangeV2_Owner>()?;
    m.add_class::<prost_bindings::conf_change_v2::Py_ConfChangeV2_Ref>()?;
    m.add_class::<prost_bindings::conf_change::Py_ConfChange_Owner>()?;
    m.add_class::<prost_bindings::conf_change::Py_ConfChange_Ref>()?;
    m.add_class::<prost_bindings::conf_state::Py_ConfState_Owner>()?;
    m.add_class::<prost_bindings::conf_state::Py_ConfState_Ref>()?;
    m.add_class::<prost_bindings::entry_type::Py_EntryType>()?;
    m.add_class::<prost_bindings::entry::Py_Entry_Owner>()?;
    m.add_class::<prost_bindings::entry::Py_Entry_Ref>()?;
    m.add_class::<prost_bindings::hard_state::Py_HardState_Owner>()?;
    m.add_class::<prost_bindings::hard_state::Py_HardState_Ref>()?;
    m.add_class::<prost_bindings::message_type::Py_MessageType>()?;
    m.add_class::<prost_bindings::message::Py_Message_Owner>()?;
    m.add_class::<prost_bindings::message::Py_Message_Ref>()?;
    m.add_class::<prost_bindings::snapshot_metadata::Py_SnapshotMetadata_Owner>()?;
    m.add_class::<prost_bindings::snapshot_metadata::Py_SnapshotMetadata_Ref>()?;
    ...
    m.add_class::<py_storage_bindings::py_storage::Py_Storage_Owner>()?;
    ...
    m.add_class::<py_storage_bindings::raw_node::Py_RawNode__PyStorage_Owner>()?;
